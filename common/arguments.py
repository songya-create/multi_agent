...
def get_args():
    ...
    parser.add_argument("--seq_len", type = int, default =3 , help = "seq_len")
    # Environment
    parser.add_argument("--scenario-name", type=str, default="simple_task1", help="name of the scenario script")
    ...
    parser.add_argument("--epsilon", type=float, default=0.4, help="epsilon greedy")
    parser.add_argument("--noise_rate", type=float, default=0.4, help="noise rate for sampling from a standard normal distribution ")
    ...
    parser.add_argument("--min_buffer-size", type = int, default = int(400),
                        help = "number of transitions can be stored in buffer")
    parser.add_argument("--better_buffer-size", type = int, default = int(5e4),
                        help = "number of transitions can be stored in buffer")
    parser.add_argument("--batch-size", type=int, default=256, help="number of episodes to optimize at the same time")
    parser.add_argument("--better_batch_size", type = int, default = 20,
                        help = "number of episodes to optimize at the same time")

    # Checkpointing
    parser.add_argument("--save-dir", type=str, default="./model", help="directory in which training state and model should be saved")
    parser.add_argument("--save-rate", type=int, default=9000, help="save model once every time this many episodes are completed")
